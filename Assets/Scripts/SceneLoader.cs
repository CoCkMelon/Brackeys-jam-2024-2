...
public class SceneLoader : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sceneRanges.Add("Rocky island", new Vector2(3000f, 5000f));
        // sceneRanges.Add("Big island", new Vector2(300f, 400f));
        // sceneRanges.Add("Populated island", new Vector2(400f, 500f));
